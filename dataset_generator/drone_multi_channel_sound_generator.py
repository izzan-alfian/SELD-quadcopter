...
distance = np.linalg.norm([3, 3, 3])
sigma2 = 10**(-snr_db / 10) / (4. * np.pi * distance)**2
room = pra.AnechoicRoom(fs=16000, air_absorption=True, sigma2_awgn=sigma2)
...
fs, signal = wavfile.read("./dataset_generator/arctic_a0010.wav")
