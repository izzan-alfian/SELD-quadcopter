...
for motor_noise_file_name in motor_noise_file_names:
    ...
    description_file_path = os.path.join(description_result_directory, motor_noise_file_name)
    df = pd.DataFrame({
    ...
    temporary_path = os.path.join(temp_directory, motor_noise_file_name)

    np.save(temporary_path, microphone_signals)
