...
wav_result_directory         = "./dataset_generator/sounds/1m_8channel_1class_drone_mic_signals/wav"
description_result_directory = "./dataset_generator/sounds/1m_8channel_1class_drone_mic_signals/description"
temp_directory               = "./dataset_generator/sounds/1m_8channel_1class_drone_mic_signals/temp"
...
mic_positions = np.array([
    [ 0.4805,  0.5000, -0.4795],
    [-0.4805,  0.5000,  0.4795],
    [-0.5000,  0.4805, -0.4795],
    [-0.5000,  0.4805,  0.4795],
    [-0.4805, -0.5000, -0.4795],
    [ 0.4805, -0.5000,  0.4795],
    [ 0.5000, -0.4805, -0.4795],
